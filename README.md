...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,934 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-10 ([npm](https://www.npmjs.com/package/nanoid)) - A tiny, secure URL-friendly unique string ID generator for JavaScript.
* [uuid](https://github.com/uuidjs/node-uuid) ⭐ 15,316 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-08 ([npm](https://www.npmjs.com/package/uuid)) - Simple, fast generation of RFC4122 UUIDS.
...
* [cuid2](https://github.com/paralleldrive/cuid2) ⭐ 3,389 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-12 ([npm](https://www.npmjs.com/package/@paralleldrive/cuid2)) - Secure, collision-resistant ids optimized for horizontal scaling and performance. Next generation uuids.
...
* [xid](https://github.com/rs/xid) ⭐ 4,280 | 🐛 18 | 🌐 Go | 📅 2026-07-24 - Xid is a globally unique id generator thought for the web.
