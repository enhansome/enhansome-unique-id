...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,943 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-10 ([npm](https://www.npmjs.com/package/nanoid)) - A tiny, secure URL-friendly unique string ID generator for JavaScript.
...
* [cuid2](https://github.com/paralleldrive/cuid2) ⭐ 3,392 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-12 ([npm](https://www.npmjs.com/package/@paralleldrive/cuid2)) - Secure, collision-resistant ids optimized for horizontal scaling and performance. Next generation uuids.
...
* [xid](https://github.com/rs/xid) ⭐ 4,282 | 🐛 19 | 🌐 Go | 📅 2026-08-26 - Xid is a globally unique id generator thought for the web.
