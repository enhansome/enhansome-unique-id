...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,964 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 ([npm](https://www.npmjs.com/package/nanoid)) - A tiny, secure URL-friendly unique string ID generator for JavaScript.
* [uuid](https://github.com/uuidjs/node-uuid) ⭐ 15,327 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-18 ([npm](https://www.npmjs.com/package/uuid)) - Simple, fast generation of RFC4122 UUIDS.
...
* [xid](https://github.com/rs/xid) ⭐ 4,283 | 🐛 18 | 🌐 Go | 📅 2026-09-07 - Xid is a globally unique id generator thought for the web.
