...
* [nanoid](https://github.com/ai/nanoid) ⭐ 26,929 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-10 ([npm](https://www.npmjs.com/package/nanoid)) - A tiny, secure URL-friendly unique string ID generator for JavaScript.
* [uuid](https://github.com/uuidjs/node-uuid) ⭐ 15,313 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-08 ([npm](https://www.npmjs.com/package/uuid)) - Simple, fast generation of RFC4122 UUIDS.
